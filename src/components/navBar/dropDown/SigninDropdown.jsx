...
const SigninDropdown = ({ options, onSelect }) => {
  ...
  return (
    <div className="relative inline-block text-left">
      <div>
        <button
          type="button"
          className="inline-flex justify-center w-full px-4 py-2 bg-none text-base font-semibold text-white hover:text-[#FFCC00]"
          id="options-menu"
