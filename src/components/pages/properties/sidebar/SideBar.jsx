...
const SideBar = () => {
  return (
    <div className='w-3/12 h-full bg-slate-600 rounded-lg border border-[#FFCC00] flex flex-col items-center justify-evenly' >
        <aside id="separator-sidebar" className="w-full h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
